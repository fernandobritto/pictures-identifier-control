...
[**getInventory**](StoreApi.md#getInventory) | **GET** /store/inventory | Returns product inventories by status
...
$order_id = 789; // int | ID of product that needs to be fetched
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **order_id** | **int**| ID of product that needs to be fetched |
...
$body = new \Swagger\Client\Model\Order(); // \Swagger\Client\Model\Order | order placed for purchasing the product
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\Order**](../Model/Order.md)| order placed for purchasing the product |
