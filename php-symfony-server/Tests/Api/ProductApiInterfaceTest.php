...
class ProductApiInterfaceTest extends WebTestCase
{
    ...
    /**
     * Test case for findproductsByStatus
     *
     * Finds products by status.
     *
     */
    public function testFindproductsByStatus()
    {
        $client = static::createClient();

        $path = '/product/findByStatus';

        $crawler = $client->request('GET', $path);
    }

    /**
     * Test case for findproductsByTags
     *
     * Finds products by tags.
     *
     */
    public function testFindproductsByTags()
    {
        $client = static::createClient();

        $path = '/product/findByTags';
    ...
    /**
     * Test case for updateproductWithForm
     *
     * Updates a product in the store with form data.
     *
     */
    public function testUpdateproductWithForm()
    {
        $client = static::createClient();
    ...
    public function testUploadFile()
    {
        ...
        $path = '/product/{productId}/uploadImage';
        $pattern = '{productId}';
        $data = $this->genTestData('\d+');
        $path = str_replace($pattern, $data, $path);
